    ...
    const handleAdd = async (e) => {
        ...
        try {
            ...
            if (response.status === 200 || response.status === 201) {
                window.alert('Field berhasil ditambahkan.');
                closeModal()
            }
            setLoading(false);
    ...
    const handleDelete = async (item) => {
        ...
        try {
            ...
            if (response.status === 200) {
                ...
                const updatedField = field.filter(k => k.id !== item.id);
                setLoading(false);
                setField(updatedField);
            }
            ...
            <div className="p-4 sm:ml-64">
                <div className="p-4 border-2 border-gray-100 rounded-md">
                    ...
                    <div className="flex items-center mb-4 rounded bg-blue-600 p-4">
                        ...
                        <div className="p-2">
                            <h1 className="text-3xl font-semibold text-white">Field</h1>
                            ...
                            <button className="bg-gray-800 text-white text-sm p-2 mt-2 rounded hover:bg-gray-700 transition" onClick={toggleFormTambah}>Tambah Field</button>
                        </div>
                    </div>
                ...
                <div className="fixed inset-0 flex items-center justify-center bg-black bg-opacity-50 z-50">
                    <div className="bg-white rounded-lg w-full max-w-md mx-4 sm:mx-auto p-6 space-y-6 shadow-lg">
                        <div className="flex justify-between items-center">
                            <h2 className="text-xl font-semibold text-gray-700">Ubah Field</h2>
                            <button
                ...
                <div className="fixed inset-0 flex items-center justify-center bg-black bg-opacity-50 z-50">
                    <div className="bg-white rounded-lg w-full max-w-md mx-4 sm:mx-auto p-6 space-y-6 shadow-lg">
                        <div className="flex justify-between items-center">
                            <h2 className="text-xl font-semibold text-gray-700">Tambah Field</h2>
                            <button
                                className="text-gray-500 hover:text-gray-700"
                                onClick={closeModal}
                            >
                        ...
                        <form className="space-y-4">
                            <div>
                                ...
                                <input
                                    ...
                                    onChange={(e) => setFieldin(e.target.value)}
                                    required
                                />
                            </div>
                            <div className="flex justify-end space-x-4">
