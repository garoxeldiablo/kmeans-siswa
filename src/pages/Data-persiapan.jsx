        ...
        <div class="p-4 sm:ml-64">
            <div class="p-4 border-2 border-gray-200 border-dashed rounded-lg">
                ...
                <div class="flex items-center mb-4 rounded bg-blue-600 p-4">
                    ...
                    <div className="p-2">
                        <h1 className="text-3xl font-semibold text-white">Nilai Rapor Siswa</h1>
                        <h3 className="text-white">Kumpulan informasi yang menunjukkan hasil belajar siswa selama satu periode atau tahun ajaran. Berdasarkan nilai rapor dari berbagai mata pelajaran.</h3>
                    </div>
                </div>
